...
ipath = "/home/pi/Salma/mouse.py"    #CHANGE PATH TO LOCATION OF mouse.py
...
for i in range(20):
    ...
    if devData[1] == ' name "USB OPTICAL MOUSE  Keyboard"':    #CHANGE THE DEVICE NAME TO THE ONE YOU ARE USING
